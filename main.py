...
from feature_extraction import extract_features_and_gold_labels_for_training_set
from feature_extraction import extract_features_and_gold_labels_for_test_set
...
trainset = extract_features_and_gold_labels_for_training_set('data/preprocessed data/train.conll')
...
testset = extract_features_and_gold_labels_for_test_set('data/argument classification/test.conll')
